...
const url = "https://backend-veterinaria.now.sh/mascotas";
...
function editar(index) {
  return function cuandoCliqueo() {
    ...
    tittleModal.innerHTML = 'Editar Mascota'
...
function resetModal() {
  nombre.value = '';
  dueno.value = $("#dueno option:first").val();
  tipo.value = $("#tipo option:first").val();
  indice.value = '';
  tittleModal.innerHTML = 'Nueva Mascota'
